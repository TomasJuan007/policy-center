INSERT INTO `tb_rule` (`id`, `rule_id`, `app`, `name`, `val`, `op`, `lft`, `rgt`, `lvl`, `is_deleted`, `created_at`, `updated_at`) VALUES (1, 1, '', 'age', '[18,25]', 'btw', 1, 26, 0, 0, '2021-01-15 19:49:10', '2021-01-18 19:45:25');
INSERT INTO `tb_rule` (`id`, `rule_id`, `app`, `name`, `val`, `op`, `lft`, `rgt`, `lvl`, `is_deleted`, `created_at`, `updated_at`) VALUES (2, 1, '', 'age', '[18,35]', 'btw', 2, 9, 1, 0, '2021-01-15 19:49:10', '2021-01-18 18:49:46');
...
INSERT INTO `tb_rule` (`id`, `rule_id`, `app`, `name`, `val`, `op`, `lft`, `rgt`, `lvl`, `is_deleted`, `created_at`, `updated_at`) VALUES (9, 1, '', 'age', '[18,25]', 'btw', 13, 14, 2, 0, '2021-01-15 19:49:10', '2021-01-18 20:55:04');
...
INSERT INTO `tb_rule` (`id`, `rule_id`, `app`, `name`, `val`, `op`, `lft`, `rgt`, `lvl`, `is_deleted`, `created_at`, `updated_at`) VALUES (11, 1, '', 'age', '[18,35]', 'btw', 19, 20, 2, 0, '2021-01-15 19:49:10', '2021-01-18 20:55:11');
INSERT INTO `tb_rule` (`id`, `rule_id`, `app`, `name`, `val`, `op`, `lft`, `rgt`, `lvl`, `is_deleted`, `created_at`, `updated_at`) VALUES (12, 1, '', 'age', '[18,35]', 'btw', 21, 22, 2, 0, '2021-01-15 19:49:10', '2021-01-18 20:55:14');
INSERT INTO `tb_rule` (`id`, `rule_id`, `app`, `name`, `val`, `op`, `lft`, `rgt`, `lvl`, `is_deleted`, `created_at`, `updated_at`) VALUES (13, 1, '', 'age', '[18,35]', 'btw', 23, 24, 2, 0, '2021-01-15 19:49:10', '2021-01-18 20:55:17');
/**
INSERT INTO `tb_rule` (`rule_id`, `app`, `name`, `val`, `op`, `lft`, `rgt`, `lvl`, `is_deleted`, `created_at`, `updated_at`)
VALUES
(#{ruleId,jdbcType=BIGINT}, '', 'age', '[18,25]', 'btw', 1, 26, 0, 0, '2021-01-15 19:49:10', '2021-01-15 19:49:10'),
(#{ruleId,jdbcType=BIGINT}, '', 'age', '[18,35]', 'btw', 2, 9, 1, 0, '2021-01-15 19:49:10', '2021-01-15 19:49:10'),
...
(#{ruleId,jdbcType=BIGINT}, '', 'age', '[18,25]', 'btw', 13, 14, 2, 0, '2021-01-15 19:49:10', '2021-01-15 19:49:10'),
(#{ruleId,jdbcType=BIGINT}, '', 'age', '[18,25]', 'btw', 15, 16, 2, 0, '2021-01-15 19:49:10', '2021-01-15 19:49:10'),
(#{ruleId,jdbcType=BIGINT}, '', 'age', '[18,35]', 'btw', 19, 20, 2, 0, '2021-01-15 19:49:10', '2021-01-15 19:49:10'),
(#{ruleId,jdbcType=BIGINT}, '', 'age', '[18,35]', 'btw', 21, 22, 2, 0, '2021-01-15 19:49:10', '2021-01-15 19:49:10'),
